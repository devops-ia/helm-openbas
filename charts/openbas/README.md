...
| postgresql.auth.username | string | `"user"` | PostgreSQL application username </br> Ref: https://github.com/bitnami/containers/tree/main/bitnami/postgresql#environment-variables |
